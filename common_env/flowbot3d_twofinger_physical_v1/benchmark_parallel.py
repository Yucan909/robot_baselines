...
def main():
    ...
    print("=" * 110)
    print("FLOWBOT3D PHYSICAL TWO-FINGER FINAL BENCHMARK")
    print("=" * 110)
    print("interaction: finger collision + friction; NO object drive")
    print("targets: 56")
    ...
    print()
    print("=" * 110)
    print("FINAL TWO-FINGER BENCHMARK SUMMARY")
    print("=" * 110)
